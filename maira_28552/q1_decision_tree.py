"""
Assignment 2 - Question 1: Decision Tree (Simplified ID3)
Student: Maira
Task: Implement information gain and build a one-level decision tree (decision stump)
...
def info_gain(data, attr, target='Play'):
    ...
    # Step 1: Compute parent entropy (the whole dataset before splitting)
